  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ecommerceApplicationApp.pesquisa.delete.question">
          <Translate contentKey="ecommerceApplicationApp.pesquisa.delete.question" interpolate={{ id: pesquisaEntity.id }}>
