...
export interface IParametrosUpdateState {
  isNew: boolean;
}

export class ParametrosUpdate extends React.Component<IParametrosUpdateProps, IParametrosUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/parametros');
  };

  render() {
    const { parametrosEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ecommerceApplicationApp.parametros.home.createOrEditLabel">
              <Translate contentKey="ecommerceApplicationApp.parametros.home.createOrEditLabel">Create or edit a Parametros</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : parametrosEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="id">
                ...
                <Button tag={Link} id="cancel-save" to="/entity/parametros" replace color="info">
