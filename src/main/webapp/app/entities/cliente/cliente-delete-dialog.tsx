  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ecommerceApplicationApp.cliente.delete.question">
          <Translate contentKey="ecommerceApplicationApp.cliente.delete.question" interpolate={{ id: clienteEntity.id }}>
